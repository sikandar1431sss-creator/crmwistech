...
if($config['csrf_protection'] == true && isset($_SERVER['REQUEST_URI']) && strpos($_SERVER['REQUEST_URI'],'invoiceRenewalCancel') !== FALSE){
    $config['csrf_protection'] = false;
}
if($config['csrf_protection'] == true && isset($_SERVER['REQUEST_URI']) && strpos($_SERVER['REQUEST_URI'],'custom_notes') !== FALSE){
    $config['csrf_protection'] = false;
}
