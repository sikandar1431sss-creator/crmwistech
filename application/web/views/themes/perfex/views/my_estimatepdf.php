...
$tblhtml = '
<table width="100%" bgcolor="#fff" border="1" cellspacing="0" cellpadding="8">
...
$items_data = get_table_items_and_taxes($invoice->items, 'estimate');
...
if ($invoice->discount_percent != 0) {
   ...
   $dis_amount = "";
    ...
    if ($invoice->discount_type == "percentage") {
        $dis_amount = '(' . _format_number($invoice->discount_percent, true) . '%' . ')';
    }

    $tbltotal .= '
    <tr>
        <td align="right" width="85%"><strong>' . _l('invoice_discount') . $dis_amount . '</strong></td>
...
if ((isset($staff->email_signature)) && $staff->email_signature <> null) {
    $toolcopy = '';
