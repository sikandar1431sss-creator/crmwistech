...
$custom_notes = getByTypePosition("proposal");
                     ...
                     <div class="col-md-6">
                      ...
                      <div class="col-md-12">
                          ...
                          <div class="form-group col-md-4">
                              ...
                              <select name="noteType" class="form-control" id="selectProposalCustomNoteHeader">
                                  <option value="">Select Custom Note</option>
                                  <?php
                          ...
                          <?php $value = (isset($proposal) ? $proposal->customNote_header : ''); ?>
                          <div class="form-group col-md-12" id="customNoteDiv">
                                    <textarea id="customNote_header" name="customNote_header"
                                              class="form-control tinymce customNote_header"><?= $value; ?></textarea>
                          </div>
              ...
              <div class="panel_s">
                  <div class="panel-body">
                      <div class="row">
                          <div class="form-group col-md-4">
                              <label>Admin Note</label>
                              <select name="noteType" class="form-control" id="selectProposalCustomNoteFooter">
                                  <option value="">Select Custom Note</option>
                                  <?php
                                  if (count($custom_notes) > 0) {
                                      foreach ($custom_notes as $note) {
                          ...
                          <?php $value = (isset($proposal) ? $proposal->customNote_footer : ''); ?>
                          <div class="form-group col-md-12" id="">
                                    <textarea id="customNote_footer" name="customNote_footer"
                                              class="form-control tinymce customNote_footer"><?= $value; ?></textarea>
                          </div>
                      </div>
                  </div>
              </div>
