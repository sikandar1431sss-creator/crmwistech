                    ...
                    <div class="panel-body _buttons">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <select name="duration" title="<?php echo _l('additional_filters'); ?>"
                                            ...
                                            <option value="day" <?php if ($this->input->get('duration') && $this->input->get('duration') == 'day') {
                                                echo "selected";
                                            }else if(!$this->input->get('duration')){ echo 'selected';} ?> ?>Day
                                            </option>
                        ...
                        <ul class="nav nav-tabs nav-justified post-tabs">
                            <li class=" <?php if ($this->input->get('status') && $this->input->get('status') == 'expiring') {
                                echo "active";
                            }else if(!$this->input->get('status')){ echo 'active';} ?>">
                                            ...
                                            if ($items->userid && format_invoice_number($items->rel_id)) {
                                                ...
                                                <tr class="client-items-<?= $items->userid; ?> items-renewals">
                                                    ...
                                                    <td>
                                                        ...
                                                        <?= getDescriptionFristLine($items->item_description); ?> <?php //. '<br/>' . $items->qty . ' * ' . $items->item_rate;
                                                        ?>
...
<?php init_tail(); ?>
<form action="<?= base_url() ?>admin/invoices/invoiceRenewalCancel" method="post" accept-charset="utf-8" id="renwal_cancel_form" novalidate="novalidate">
    ...
    <textarea class="form-control" style="display:none;" id="renewal_cancel_items" name="renewal_cancel_items" ></textarea>
...
<script>
    $(document).ready(function () {
        ...
        $("#create_invoice_tax").click(function () {
