                    ...
                    <td>
                        ...
                        if (isset($data['invoice_id'])) {
                            ...
                            if ($data['invoice_status'] != 5) {
                                echo _l('statement_invoice_details', array('<a style="color:' . $color . '" href="' . admin_url('invoices/list_invoices/' . $data['invoice_id']) . '" target="_blank">' . format_invoice_number($data['invoice_id']) . '</a>' ,_d($data['duedate']))) . $data['adminnote'];
                            } else {
                                echo '<strike>' . _l('statement_invoice_details', array('<a style="color:' . $color . '" href="' . admin_url('invoices/list_invoices/' . $data['invoice_id']) . '" target="_blank">' . format_invoice_number($data['invoice_id']) . '</a>',_d($data['duedate']))) . '</strike>' . $data['adminnote'];
                            }
