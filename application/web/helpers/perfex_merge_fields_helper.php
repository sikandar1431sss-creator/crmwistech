...
function get_receipt_merge_fields($receipt_id, $payment_id = false)
{
    ...
    $fields['{receipt_number}'] = format_receipt_number($receipt_id);
    $fields['{receipt_chequeDate}'] = _d($receipt->receipt_cheque_date);
    $fields['{receipt_bank}'] = _d(function_exists('get_receipt_bank_name') ? get_receipt_bank_name($receipt) : $receipt->receipt_bank);
