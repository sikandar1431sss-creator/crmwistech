    ...
    <div class="panel-body">
        <div class="col-md-10 col-md-offset-1">
            <div class="row">
                <div class="col-md-6">
                    <div class="mtop10 display-block">
                        ...
                        <?php if($invoice->pinv_reference != '') { ?>
                            &nbsp;
                            <span id="pinv_reference">
                          <?php echo '<strong>Ref: PINV-00'.$invoice->pinv_reference.'</strong>'; ?>
                       </span>
                        <?php } ?>
                    </div>
            ...
            <?php foreach($invoice->attachments as $attachment){
                ...
                <?php if(!empty($invoice->terms) || $bank_details_html !== ''){ ?>
                <div class="col-md-12">
                    <hr />
