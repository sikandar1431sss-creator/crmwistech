      ...
      <div class="row">
         <div class="col-md-12">
            <div class="panel_s">
                     ...
                     <div class="col-md-4 border-right">
                      ...
                      <p>
                        <a href="#" class="font-medium" onclick="init_report(this,'customers-report'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('report_sales_type_customer'); ?></a>
                         ...
                         <hr class="hr-10" />
                         <p>
                             <a href="#" class="font-medium" onclick="init_report(this,'balance-report'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> Customer Balance Report</a>
                         </p>
               ...
               <?php $this->load->view('admin/reports/includes/sales_balance'); ?>
