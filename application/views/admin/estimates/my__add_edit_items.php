    ...
    <div class="table-responsive s_table">
        <table class="table estimate-items-table items table-main-estimate-edit no-mtop">
            ...
            <tr class="main">
                ...
                <td>
                    <textarea name="long_description" id="long_description0" rows="4" class="form-control item_long_description" placeholder="<?php echo _l('item_long_description_placeholder'); ?>"></textarea>
                </td>
            ...
            <?php if (isset($estimate) || isset($add_items)) {
                ...
                foreach ($add_items as $item) {
                    ...
                    $table_row .= '</td>';
                    $table_row .= '<td class="bold description"><textarea name="' . $items_indicator . '[' . $i . '][description]" class="form-control" rows="5">' . $item['description'] . '</textarea></td>';
                    $table_row .= '<td><textarea  id="item_type_dom' . $i . '" name="' . $items_indicator . '[' . $i . '][long_description]" class="form-control item_long_description" rows="5">' . $item['long_description'] . '</textarea></td>';
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo render_textarea('description', '', '', array('id' => 'set_description'), array(), '', 'tinymce description'); ?>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" id="apply_description" data-dismiss="modal">Apply</button>
