            ...
            <div class="display-block text-right">
                <div class="btn-group pull-right mleft4 invoice-view-buttons btn-with-tooltip-group _filter_data"
                    ...
                    <ul class="dropdown-menu width300">
                        ...
                        <li class="divider"></li>
                        <li class="<?php if ($this->input->get('filter') == 'posted') {
                            echo 'active';
                        } ?>">
                            <a href="#" data-cview="posted"
                               onclick="dt_custom_view('posted','.table-invoices','posted'); return false;">
                                <?php echo _l('Posted'); ?>
                            </a>
                        </li>
                        <li class="<?php if ($this->input->get('filter') == 'not_posted') {
                            echo 'active';
                        } ?>">
                            <a href="#" data-cview="not_posted"
                               onclick="dt_custom_view('not_posted','.table-invoices','not_posted'); return false;">
                                <?php echo _l('Not Posted'); ?>
                            </a>
                        </li>
