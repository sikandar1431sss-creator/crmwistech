        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <?php }
                  echo '<span id="inv_prefix_tax"> ' . trim($prefix) . '</span>';
                  ?>
                     ...
                     <span id="prefix_year" class="format-mm-yyyy"><?php echo $yyyy; ?></span>
                        ...
                        <?php } ?>
                        <input type="hidden" name="prefix" id="wis_inv_number_prefix" value='<?= $prefix; ?>'>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="panel_s no-shadow">
                    <div class="form-group">
                        ...
                        <select name="type" id="wis_invoice_type" class="selectpicker"
                                data-width="100%"
                                data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                            <option value="performa" <?php if (isset($invoice) && $invoice->type == 'performa') {
                                echo 'selected';
                            } ?>><?php echo _l('invoice_type_performa'); ?></option>
                            <option value="invoice" <?php if (isset($invoice) && $invoice->type == 'invoice') {
                                echo 'selected';
            ...
            <div class="panel-body bottom-transaction">
                ...
                <div class="form-group" id="customNoteDiv">
                                <textarea id="terms" name="terms"
                                          class="form-control tinymce terms"><?= $value; ?></textarea>
                </div>
                <hr/>
...
<script>
    jQuery(function () {
        ...
        function applyCustomerCurrency(showAlert) {
            ...
            jQuery.getJSON(admin_url + 'invoices/client_change_data/' + customerId, function (response) {
