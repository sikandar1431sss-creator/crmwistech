        ...
        <table class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        if (isset($data['invoice_id'])) {
                            ...
                            if ($data['invoice_status'] != 5) {
                                echo '<a style="color:' . $color . '" href="' . admin_url('invoices/list_invoices/' . $data['invoice_id']) . '" target="_blank">' . format_invoice_number($data['invoice_id']) . '</a> ' . $data['adminnote'];
                            } else {
                                echo '<strike>' . '<a style="color:' . $color . '" href="' . admin_url('invoices/list_invoices/' . $data['invoice_id']) . '" target="_blank">' . format_invoice_number($data['invoice_id']) . '</a></strike>' . $data['adminnote'];
                            }
                    ...
                    <td class="text-right">
                        ...
                        if(!isset($data['credit_id'])){
                            ...
                            $last_balance = _format_number($tmpBeginningBalance);
                        }
                        ?>
                    </td>
                </tr>
            ...
            <tr>
                ...
                <td class="text-right" colspan="2">
                    <b><?php
                        echo format_money($statement['balance_due'], $statement['currency']->symbol);
                     /*   if(isset($last_balance)){
                            echo format_money($last_balance,$statement['currency']->symbol);
                        }else {
                            echo format_money($statement['balance_due'], $statement['currency']->symbol);
                        }*/
                        ?>
