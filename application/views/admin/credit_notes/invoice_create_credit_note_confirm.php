...
<div class="modal fade" id="confirm_credit_note_create_from_invoice"
     data-balance-due="<?= ($invoice->total_left_to_pay <> null) ? $invoice->total_left_to_pay : ""; ?>" tabindex="-1"
     role="dialog" aria-labelledby="modalLabelCreditNoteFromInvoice">
