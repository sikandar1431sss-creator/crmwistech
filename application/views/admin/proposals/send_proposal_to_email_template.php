                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            $selected = array();
                            $contacts = $this->clients_model->get_contact_prposal($proposal->rel_id,array('active'=>1));
                           /* echo "<pre>";
                            print_r($proposal);
                            die('sad');*/
                        ...
                        <div class="form-group">
                            ...
                            <input required value="Proposal with number <?= format_proposal_number($proposal->id); ?>" type="text"
