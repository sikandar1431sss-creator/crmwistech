                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 leads-filter-column">
                                                <?php echo render_select('view_created', $staff, array('staffid', array('firstname', 'lastname')), '', '', array('readonly' => $readonly, 'data-width' => '100%', 'data-none-selected-text' => _l('leads_dt_created_by')), array(), 'no-mbot'); ?>
                                            </div>
