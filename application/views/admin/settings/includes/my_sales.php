...
<div class="tab-content">
   ...
   <div role="tabpanel" class="tab-pane" id="invoice">
      ...
      <hr />
       <div class="form-group">
           <label class="control-label" for="performa_invoice_prefix"><?php echo _l('settings_sales_performa_invoice_prefix'); ?></label>
           <input type="text" name="settings[performa_invoice_prefix]" class="form-control" value="<?php echo get_option('performa_invoice_prefix'); ?>">
       </div>
       <hr />
