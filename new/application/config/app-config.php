...
*
*/
define('APP_BASE_URL', 'https://wiscrm.com/new/');
...
*/
define('APP_ENC_KEY', '95df4da6686aba96d2c00996fddb7b61');
 ...
 */
define('APP_DB_USERNAME', 'wiscrmcom_new99');

/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'Wisdom@987');

/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'wiscrmcom_new99');
