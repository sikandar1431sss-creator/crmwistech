...
function create($array)
	{
		$data = array(
			...
			'modify_date' => $array['modify_date'],
			'create_userID' => $array['create_userID'],
			'create_username' => $array['create_username'],
			'create_usertype' => $array['create_usertype'],
			'studentactive' => $array['studentactive']
			 ); 
