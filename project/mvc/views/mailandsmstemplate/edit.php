                            ...
                            <div class="col-sm-4">
                                <?php
                                    $array = array(
                                        ...
                                        'Visitor' => $this->lang->line('mailandsmstemplate_Visitor'),
                        ...
                        ?>
                            ...
                            <div class="col-sm-8" >
                                <div class="col-sm-12 border" id="email_tags">
                                    ...
                                    <div id="email_Visitor">
                                        <?php
                                            if(count($Visitors)) {
                                                foreach ($Visitors as $key => $Visitor) {
                                                    echo '<input class="btn bg-black btn-xs email_alltag" type="button" value="'.$Visitor->tagname.'"> ';
                                                }
                                            }
                                        ?>
                                    </div>
                                ...
                                <div class="col-sm-12 border" id="sms_tags">
                                    ...
                                    <div id="sms_Visitor">
                                        <?php
                                            if(count($Visitors)) {
                                                foreach ($Visitors as $key => $Visitor) {
                                                    echo '<input class="btn bg-black btn-xs sms_alltag" type="button" value="'.$Visitor->tagname.'"> ';
                                                }
                                            }
                                        ?>
                                    </div>
