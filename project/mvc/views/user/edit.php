                        ...
                        <div class="col-sm-6">
                            <?php
                                echo form_dropdown("usertype", array(
                                    "Accountant" => $this->lang->line("accountant"), "Visitor" => $this->lang->line("Visitor"),
                                    "Receptionist" => $this->lang->line("Receptionist")), set_value("usertype", $user->usertype), "id='usertype' class='form-control'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
