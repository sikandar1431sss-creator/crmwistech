$(document).ready(function () {
    ...
    //### get id of the clicked text area
    $long_description = "";
    ...
    //### Assign value to the text box after editing
    ...
    $(document).ready(function () {
        ...
        // $(document).find('.isRenewable').click(function (event) {
        $(document).on('click', '.isRenewable', function () {
    ...
    $(document).ready(function () {
        ...
        $("#clientid").change(function () {
            ...
            $.ajax({
                type: "POST",
                url: "/admin/receipts/get_ajax_client_contacts",
